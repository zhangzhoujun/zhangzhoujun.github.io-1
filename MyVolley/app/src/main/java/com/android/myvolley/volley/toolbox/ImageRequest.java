...
public class ImageRequest extends Request<Bitmap> {
    ...
    public ImageRequest(String url, Response.Listener<Bitmap> listener, int maxWidth, int maxHeight,
        ...
        setRetryPolicy(new DefaultRetryPolicy(VolleyConfig.IMAGE_TIMEOUT_MS, VolleyConfig.IMAGE_MAX_RETRIES,
                VolleyConfig.IMAGE_BACKOFF_MULT));
        mListener = listener;
    ...
    @Override
    protected void deliverResponse(Bitmap response, Object tag) {
