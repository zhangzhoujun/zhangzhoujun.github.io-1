...
package com.android.myvolley.volley;
...
import com.android.myvolley.volley.VolleyLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     * 
     * @deprecated Use {@link#Request(int, String,
     *             com.kalemao.talk.volley.Response.ErrorListener)} .
     */
     ...
     * @param object
     */
    abstract protected void deliverResponse(T response, Object object);
     ...
     * @param object
     */
    public void deliverError(VolleyError error, Object object) {
        if (mErrorListener != null) {
            mErrorListener.onErrorResponse(error, object);
        }
    }
