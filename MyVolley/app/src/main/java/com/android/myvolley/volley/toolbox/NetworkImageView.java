...
import com.android.myvolley.volley.toolbox.ImageLoader.ImageContainer;
import com.android.myvolley.volley.toolbox.ImageLoader.ImageListener;
...
public class NetworkImageView extends ImageView {
    ...
    private void loadImageIfNecessary(final boolean isInLayoutPass) {
        ...
        ImageContainer newContainer = mImageLoader.get(mUrl, new ImageListener() {
            ...
            @Override
            public void onErrorResponse(com.android.myvolley.volley.VolleyError error, Object tag) {
                if (mErrorImageId != 0) {
