...
class DToast: NSObject {
    
    public static func getDTCurrentWindow() -> UIWindow? {
    ...
    class func showToastAction() {
        if Thread.main.isMainThread {
            ...
            guard let aWin = getDTCurrentWindow() else { return }
    ...
    class func showToastAction(message: String) {
        self.showToast(message: NSString(string: message), aLocationStr: "center", aShowTime: 3.0)
    }
    
    class func showToastActionBottom(message: String) {
        self.showToast(message: NSString(string: message), aLocationStr: "bottom", aShowTime: 3.0)
    }
