package com.kalemao.library.refresh;
...
public class SuperSwipeRefreshLayout extends ViewGroup {
    private static String                LOG_TAG                         = "CustomeSwipeRefreshLayout";
    ...
    // 是否默认使用卡乐猫的头部
    private boolean                      usingKLMDefaultHeader           = true;
                                                                             ...
                                                                             public void onAnimationEnd(Animation animation) {
                                                                                 ...
                                                                                 if (mRefreshing) {
                                                                                     if (mNotify) {
                                                                                         ...
                                                                                         if (mListener != null) {
                                                                                             if (usingKLMDefaultHeader) {
                                                                                                 mHeadTextView.setText(getString(R.string.refresh_ing));
    ...
    private void updateListenerCallBack() {
        ...
        if (mListener != null) {
            mListener.onRefreshPullDistance(distance);
        }
    ...
    public SuperSwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        setHeaderViewBackgroundColor(Color.rgb(245, 245, 245));
    ...
    private void createHeaderViewContainer() {
        ...
        setHeaderView(createNewHeaderView());
        usingKLMDefaultHeader = true;
    }
     ...
     * @return
     */
    private RelativeLayout createNewHeaderView() {
        mHeadView = (RelativeLayout) LayoutInflater.from(getContext()).inflate(R.layout.layout_head, null);
        mHeadProgressBar = (ProgressBar) mHeadView.findViewById(R.id.pb_view);
        mHeadTextView = (TextView) mHeadView.findViewById(R.id.text_view);
        mHeadTextView.setText(getString(R.string.refresh_pull_down));
        mHeadImageView = (ImageView) mHeadView.findViewById(R.id.image_view);
        mHeadImageView.setVisibility(View.VISIBLE);
        mHeadImageView.setImageResource(R.drawable.down_arrow);
    ...
    private void createFooterViewContainer() {
        mFooterViewContainer = createFooterView();
     ...
     * 默认的底部的布局
     */
    private RelativeLayout createFooterView() {
        footerView = (RelativeLayout) LayoutInflater.from(getContext()).inflate(R.layout.layout_footer, null);
        ...
        footerTextView.setText(getString(R.string.refresh_pull_up));
        return footerView;
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        mHeadViewContainer.layout((width / 2 - headViewWidth / 2), mCurrentTargetOffsetTop, (width / 2 + headViewWidth / 2),
        ...
        mFooterViewContainer.layout((width / 2 - footViewWidth / 2), height - pushDistance, (width / 2 + footViewWidth / 2),
                ...
                if (overscrollTop < mTotalDragDistance) {
                    ...
                    if (mListener != null) {
                        if (usingKLMDefaultHeader) {
                            ...
                            mHeadProgressBar.setVisibility(View.GONE);
                            mHeadImageView.setVisibility(View.VISIBLE);
                            mHeadProgressBar.setRotation(0);
                        }
                        mListener.onRefreshPullEnable(false);
                    }
                } else {
                    if (mListener != null) {
                        if (usingKLMDefaultHeader) {
                            mHeadTextView.setText(getString(R.string.refresh_release_refresh));
                            mHeadProgressBar.setVisibility(View.GONE);
                            mHeadImageView.setVisibility(View.VISIBLE);
                            mHeadProgressBar.setRotation(180);
                        }
                        mListener.onRefreshPullEnable(true);
                    }
                }
        ...
        case MotionEvent.ACTION_MOVE: {
            ...
            if (mIsBeingDragged) {
                ...
                if (mOnPushLoadMoreListener != null) {
                    ...
                    footerTextView.setText(pushDistance >= mFooterViewHeight ? getString(R.string.refresh_pull_up_release) : getString(R.string.refresh_pull_up));
                    footerImageView.setVisibility(View.VISIBLE);
                    footerImageView.setRotation(pushDistance >= mFooterViewHeight ? 0 : 180);
                    mOnPushLoadMoreListener.onLoadMorePushEnable(pushDistance >= mFooterViewHeight);
                }
            }
            break;
        }
        ...
        case MotionEvent.ACTION_CANCEL: {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
                ...
                if (pushDistance == mFooterViewHeight && mOnPushLoadMoreListener != null) {
                    mLoadMore = true;
                    footerTextView.setText(getString(R.string.refresh_up_ing));
    ...
    private void updatePushDistanceListener() {
        if (mOnPushLoadMoreListener != null) {
            mOnPushLoadMoreListener.onLoadMorePushDistance(pushDistance);
        }
    }
