...
/**
 * @ClassName JYRecycleViewDivider
 * @Description TODO
 * @Author zhangzhoujun
 * @Date 2020/5/15 8:08 PM
 * @Version 1.0
 */
public class JYRecycleViewDivider extends RecyclerView.ItemDecoration {
     ...
     */
    public JYRecycleViewDivider(Context context, int orientation) {
     ...
     */
    public JYRecycleViewDivider(Context context, int orientation, int drawableId) {
     ...
     */
    public JYRecycleViewDivider(Context context, int orientation, int dividerHeight, int dividerColor) {
        this(context, orientation);
