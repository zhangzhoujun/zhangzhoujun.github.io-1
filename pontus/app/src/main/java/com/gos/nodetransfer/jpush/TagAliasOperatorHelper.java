...
//                        } else {
//                            DLog.e(TAG, "#unexcepted - context was null");
//                        }
//                    } else {
//                        DLog.w(TAG, "#unexcepted - msg obj was incorrect");
//                    }
//                    break;
//                case DELAY_SET_MOBILE_NUMBER_ACTION:
//                    if (msg.obj != null && msg.obj instanceof String) {
//                        DLog.i(TAG, "retry set mobile number");
//                        sequence++;
...
//        DLog.d(TAG, "sequence:" + sequence + ",mobileNumber:" + mobileNumber);
...
//            DLog.w(TAG, "tagAliasBean was null");
//            return;
//        }
...
//                    break;
//                default:
//                    DLog.w(TAG, "unsupport alias action type");
//                    return;
//            }
//        } else {
//            switch (tagAliasBean.action) {
...
//                    break;
//                default:
//                    DLog.w(TAG, "unsupport tag action type");
//                    return;
//            }
//        }
//    }
...
//            DLog.w(TAG, "no network");
//            return false;
//        }
//        //返回的错误码为6002 超时,6014 服务器繁忙,都建议延迟重试
//        if (errorCode == 6002 || errorCode == 6014) {
//            DLog.d(TAG, "need retry");
//            if (tagAliasBean != null) {
...
//        DLog.i(TAG, "action - onTagOperatorResult, sequence:" + sequence + ",tags:" + jPushMessage.getTags());
//        DLog.i(TAG, "tags size:" + jPushMessage.getTags().size());
//        init(context);
...
//            DLog.i(TAG, "action - modify tag Success,sequence:" + sequence);
...
//        int sequence = jPushMessage.getSequence();
//        DLog.i(TAG, "action - onCheckTagOperatorResult, sequence:" + sequence + ",checktag:" + jPushMessage.getCheckTag());
//        init(context);
//        //根据sequence从之前操作缓存中获取缓存记录
//        TagAliasBean tagAliasBean = (TagAliasBean) setActionCache.get(sequence);
//        if (tagAliasBean == null) {
...
//        }
//        if (jPushMessage.getErrorCode() == 0) {
//            DLog.i(TAG, "tagBean:" + tagAliasBean);
//            setActionCache.remove(sequence);
...
//        int sequence = jPushMessage.getSequence();
//        DLog.i(TAG, "action - onAliasOperatorResult, sequence:" + sequence + ",alias:" + jPushMessage.getAlias());
//        init(context);
//        //根据sequence从之前操作缓存中获取缓存记录
//        TagAliasBean tagAliasBean = (TagAliasBean) setActionCache.get(sequence);
//        if (tagAliasBean == null) {
...
//        }
//        if (jPushMessage.getErrorCode() == 0) {
//            DLog.i(TAG, "action - modify alias Success,sequence:" + sequence);
//            setActionCache.remove(sequence);
...
//        int sequence = jPushMessage.getSequence();
//        DLog.i(TAG, "action - onMobileNumberOperatorResult, sequence:" + sequence + ",mobileNumber:" + jPushMessage.getMobileNumber());
//        init(context);
//        if (jPushMessage.getErrorCode() == 0) {
//            DLog.i(TAG, "action - set mobile number Success,sequence:" + sequence);
//            setActionCache.remove(sequence);
//        } else {
