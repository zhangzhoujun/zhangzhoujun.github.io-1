...
class JuggleGoodsAdapter (
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        var view =
            LayoutInflater.from(context).inflate(R.layout.juggle_main_item_good_skin, parent, false)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        var bind: JuggleMainItemGoodSkinBinding = DataBindingUtil.bind(holder.itemView)!!
