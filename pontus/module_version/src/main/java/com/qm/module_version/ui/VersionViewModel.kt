...
import com.qm.lib.entity.VersionCloseEvent
 ...
 * @Version 1.0
 */
class VersionViewModel(application: Application) : BaseAppViewModel(application) {
    ...
    var startDown = ObservableBoolean(false)
    ...
    fun onCloseDialog(view: View?) {
        ...
        RxBus.getDefault().post(VersionCloseEvent())
        onBackPressed()
    }
    ...
    private fun downApk() {
        ...
        mDisposable = create(mMission!!, true)
            ...
            .subscribe { status ->
                ...
                percent.set("正在下载 " + status.percent())
